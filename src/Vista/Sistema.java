...
public class Sistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtTeléfonoCV = new javax.swing.JTextField();
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/segunda.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 0, 850, 160));
        ...
        TableVenta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO", "DESCRIPCIÓN", "CANDTIDAD", "PRECIO", "TOTAL"
            }
        ));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtCantidadVenta, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(55, 55, 55)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(txtNombreClienteventa, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(txtTeléfonoCV, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(txtDireccionCV, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(txtRazonCV, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(54, 54, 54)
        ...
        jLabel16.setText("Razon Socia:l");
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(36, 36, 36)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtDniCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(txtPrecioPro, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 76, Short.MAX_VALUE)
        ...
        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 160, 850, 360));
    ...
    private void TableClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableClienteMouseClicked
        ...
        String id = TableCliente.getValueAt(row, 0).toString();
        String dni = TableCliente.getValueAt(row, 1).toString();
        String nombre = TableCliente.getValueAt(row, 2).toString();
        String telefono = TableCliente.getValueAt(row, 3).toString();
        String direccion = TableCliente.getValueAt(row, 4).toString();
        txtIdCliente.setText(id);
        txtDniCliente.setText(dni);
        txtNombreCliente.setText(nombre);
        txtDniCliente.setText(telefono);
        txtDireccionCliente.setText(direccion);
        System.out.print(id + dni + nombre + telefono + direccion);
...
// TODO add your handling code here:
    ...
    private void btnEliminarProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarProveedorActionPerformed
        ...
        if (!"".equals(txtIdProveedor.getText())) {
            int pregunta = JOptionPane.showConfirmDialog(null, "estas seguro de elinimar");
            if (pregunta == 0) {
    ...
    private void btnEditarProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarProveedorActionPerformed
        ...
        if ("".equals(txtIdProveedor.getText())) {
            ...
            if (!"".equals(txtRucProveedor.getText()) || !"".equals(txtNombreProveedor.getText()) || !"".equals(txtTelefonoProveedor.getText()) || !"".equals(txtDireccionProveedor.getText()) || !"".equals(txtRazonProveedor.getText())) {
               ...
               pr.setDireccion(txtDireccionProveedor.getText());
               pr.setRazon(txtRazonProveedor.getText());
               pr.setId(txtIdProveedor.getText());
    ...
    private void btnGuardarProActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarProActionPerformed
        ...
        if (!"".equals(txtCodigoPro.getText()) || !"".equals(txtDesPro.getText()) || !"".equals(cbxProveedorPro.getSelectedItem()) || !"".equals(txtCantPro.getText()) || !"".equals(txtPrecioPro.getText())) {
            ...
            pro.setStock(txtCantPro.getText());
        ...
        // TODO add your handling code here:
         if ("".equals(txtIdPro.getText())) {
            ...
            if (!"".equals(txtCodigoPro.getText()) || !"".equals(txtDesPro.getText()) || !"".equals(txtCantPro.getText()) || !"".equals(txtPrecioPro.getText())) {
               pro.setCodigo((txtRucProveedor.getText()));
               pro.setNombre(txtDesPro.getText());
               pro.setProveedor(cbxProveedorPro.getSelectedItem().toString());
               pro.setStock(txtCantPro.getText());
               pro.setPrecio(Double.parseDouble(txtPrecioPro.getText()));
               pro.setId(txtIdPro.getText());
    ...
    private void txtCodigoVentaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoVentaKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!"".equals(txtCodigoVenta.getText())) {
                ...
                JOptionPane.showMessageDialog(null, "ingerese el codigo del producto");
                txtCodigoVenta.requestFocus();
            }
        }
        ...
        if (evt.getKeyCode() ==KeyEvent.VK_ENTER) {
            if (!"".equals(txtRucVenta.getText())) {
                ...
                if (cl.getNombre() != null) {
                    ...
                    txtTeléfonoCV.setText(""+cl.getTelefono());
    ...
    private javax.swing.JTextField txtTeléfonoCV;
    ...
    private void pdf(){
        try {
            FileOutputStream arachivo;
            File file = new File("src/pdfventa.pdf");
